...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  // api.ai client
  const apiClient = new ApiAi.ApiAiClient({accessToken: 'dbaad7c790374e7a9d2d9d4d9e1798a1'});

  // Initial feedback message.
  addBotItem("Hi! I’m grammarbot. Tap the microphone and start talking to me.");
  ...
  recognition.onresult = function(ev) {
    ...
    function handleResponse(serverResponse) {
      ...
      const speech = serverResponse["result"]["fulfillment"]["messages"][i].speech;
